...
class _HomeState extends State<Home> {
              ...
              Expanded(
                child: GridView.count(
                  ...
                  children: [
                    ...
                    bottomMenu("Pendentes de envio", Icons.email, PendentsScreen()),
                    bottomMenu("Histórico de sorteios", Icons.history, HistoricScreen()),
                  ]
                ),
              ),
            ],
  ...
  bottomMenu(String label, IconData icon, Widget nextPage){
    return InkWell(
      onTap: nextPage ==null?nextPage:() async{
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
            ...
            color: nextPage== null?AppColors.primary.withOpacity(.84):AppColors.primary
        ),
