...
class _ParticipantsListScreenState extends State<ParticipantsListScreen> {
  ...
  participantsList(List<Participant>list, ){
                ...
                Flexible(
                  child: ExpansionTile(
                    ...
                    children: [
                      ...
                      SizedBox(height: 10,),
                      Text(list[index].address.street + " - "+ list[index].address.number),
                      SizedBox(height: 10,),
                      Text(list[index].address.district+ " - "+ list[index].address.city),
                      SizedBox(height: 10)
                    ],
                  ),
                ),
                IconButton(icon: Icon(Icons.delete,color: Colors.red,), onPressed:(){
                  ...
                  dialodDelete(context).then((value){
                    if(value){
                      ...
                      BlocProvider.of<AppBloc>(context).sinkParticipants(listaux);
                    }
                  });
