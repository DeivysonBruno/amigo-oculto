...
class Raffle {
  ...
  Raffle.fromMap(Map map) {
    ...
    combinations = (map['combinations'] as List)
        .map((e) => Combination.fromMap(e))
        .toList();
  }
  ...
  toMap() {
    ...
    combinations.forEach((element) {
      if (element.origin.isModerator) hasModerator = true;
    });
    return {
      "name": this.name,
...
class Combination {
  ...
  Map toMap() {
    return {"origin": this.origin.toMap(), "friend": this.friend.toMap()};
  }
